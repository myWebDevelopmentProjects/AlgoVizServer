...
<html>
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="/AlgoVizServer/favicon.ico">
    ...
    <body>
        <modal-window>
            <screen-error class="_config">
                <error-title class="title"><error-title-icon></error-title-icon><span>ПОМИЛКА!</span></error-title>
                <error-msg class="js-error-msg">DEFAULT</error-msg>
                <btn-close-modal><btn-close-icon></btn-close-icon><span>ЗАКРИТИ</span></btn-close-modal>
            </screen-error>
        </modal-window>
